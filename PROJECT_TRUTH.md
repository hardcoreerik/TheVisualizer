...
- `.tvscene` format 2 stores complete Particle Forge state while format-1 scenes remain readable with forge defaults.
...
- Forty-three focused player tests cover the existing analysis, capture, interaction, Studio, preset, scene, and Visual Director contracts plus Particle Forge quality budgets, force-node bounds, modulation clamping, and complete forge-state round-trip. Separate SDK and example-plugin lifecycle tests also pass.
