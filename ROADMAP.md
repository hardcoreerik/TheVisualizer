...
| 3. Renderer and player | In progress | Three bundled visuals run through the shared renderer in windowed, borderless, and fullscreen modes |
| 4. Presets and native plugins | Complete | WGSL presets load safely; one explicitly approved example native plugin passes the versioned host-owned lifecycle |
...
- Produce time, waveform, spectrum, RMS, peak, and low/mid/high-band values.
