...
The package is intentionally portable: extraction is installation, and deleting the extracted directory is uninstallation. The original project work is Apache-2.0. A future public release still requires broader hardware validation, release metadata/icon work, and a decision on installer/signing/update infrastructure.
